...
summary: This paper demonstrates that jointly learning bias and stereotype detection using the new StereoBias dataset significantly improves bias detection in language models, underscoring the importance of leveraging stereotype information to build fairer AI systems.
